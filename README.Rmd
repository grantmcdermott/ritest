...
experimental design, if any.
- `...` are other arguments, including the ability to set a random seed for
...
Say we're particularly interested in the yield effect of 'N' (i.e. nitrogen).
We want to known whether our inferential reasoning about this parameter is 
