...
has been available for nearly a decade. More recently, the successor [**ri2**](https://cran.r-project.org/web/packages/ri2/index.html) package
...
`ri2::conduct_ri()`, which is what `ritest::ritest()` was designed for. Your use
case will likely determine which software is optimal for you.
