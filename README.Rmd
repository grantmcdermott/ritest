...
[`Installation`](#Installation) | [`Examples`](#Examples) ([`i`](#toy-data), [`ii`](#real-life-data)) | [`Benchmarks`](#Benchmarks)
...
I'll also load the **fixest**, **modelsummary**, and **haven** packages to help 
