...
As final illustration using our toy data, we'll test a more realistic model
that controls for the stratified (aka "blocked") design of the original `npk`
experiment. We'll do this by specifying these strata (blocks) as fixed-effects in 
...
(`|>`) that was introduced in R 4.1.1.
