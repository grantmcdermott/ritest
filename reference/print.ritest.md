# A print method for ritest objects

Printed display of ritest objects. Tries to mimic the display of the
equivalent Stata routine.
...
- verbose:
  ...
  Logical. Should we display the original model summary too? Default is
  FALSE.
