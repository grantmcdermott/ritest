...
version and is currently limited to
[`lm()`](https://rdrr.io/r/stats/lm.html) and
[`fixest::feols()`](https://lrberge.github.io/fixest/reference/feols.html)
models. But it does appear to be significantly faster, and aims to
support a variety of model classes once it is fully baked.
...
vignette. See
[`vignette("ritest")`](http://grantmcdermott.com/ritest/articles/ritest.md).
...
vignette**](http://grantmcdermott.com/ritest/articles/ritest.md).
